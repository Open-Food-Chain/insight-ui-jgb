angular.module('insight').run(['gettextCatalog', function (gettextCatalog) {
    ...
    gettextCatalog.setStrings('de_DE', {
        ...
        "<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href=\"https://github.com/bitpay/insight/issues\" target=\"_blank\">github issue tracker</a>.": "<strong>insight</strong> befindet sich aktuell noch in der Entwicklung. Bitte sende alle gefundenen Fehler (Bugs) und Feedback zur weiteren Verbesserung an unseren <a href=\"https://github.com/supernetorg/insight-ui-komodo/issues\" target=\"_blank\">Github Issue Tracker</a>.",
        "About": "Über insight",
        "Address": "Adresse",
        "Age": "Alter",
        "Application Status": "Programmstatus",
        "Best Block": "Bester Block",
        "Komodo node information": "Komodo-Node Info",
        "Block": "Block",
        "Block Reward": "Belohnung",
        "Blocks": "Blöcke",
        "Bytes Serialized": "Serialisierte Bytes",
        "Can't connect to komodod to get live updates from the p2p network. (Tried connecting to komodod at {{host}}:{{port}} and failed.)": "Es ist nicht möglich mit Komodod zu verbinden um live Aktualisierungen vom P2P Netzwerk zu erhalten. (Verbindungsversuch zu komodod an {{host}}:{{port}} ist fehlgeschlagen.)",
        ...
        "Last Block Hash (Komodod)": "Letzter Hash (Komodod)",
    ...
    gettextCatalog.setStrings('es', {
        ...
        "Can't connect to komodod to get live updates from the p2p network. (Tried connecting to komodod at {{host}}:{{port}} and failed.)": "No se pudo conectar a komodod para obtener actualizaciones en vivo de la red p2p. (Se intentó conectar a komodod de {{host}}:{{port}} y falló.)",
    ...
    gettextCatalog.setStrings('ja', {
        ...
        "Best Block": "最良ブロック",
        "Komodo comes with a way of signing arbitrary messages.": "Komodoには任意のメッセージを署名する昨日が備わっています。",
        "Komodo node information": "Komodoノード情報",
        "Block": "ブロック",
        "Block Reward": "ブロック報酬",
        "Blocks": "ブロック",
        "Broadcast Raw Transaction": "生のトランザクションを配信",
        "Bytes Serialized": "シリアライズ後の容量 (バイト)",
        "Can't connect to komodod to get live updates from the p2p network. (Tried connecting to komodod at {{host}}:{{port}} and failed.)": "P2Pネットワークからライブ情報を取得するためにkomododへ接続することができませんでした。({{host}}:{{port}} への接続を試みましたが、失敗しました。)",
        ...
        "Input": "入力",
        "Last Block": "直前のブロック",
        "Last Block Hash (Komodod)": "直前のブロックのハッシュ値 (Komodod)",
        ...
        "This form can be used to broadcast a raw transaction in hex format over\n        the Komodo network.": "このフォームでは、16進数フォーマットの生のトランザクションをKomodoネットワーク上に配信することができます。",
        "This form can be used to verify that a message comes from\n        a specific Komodo address.": "このフォームでは、メッセージが特定のKomodoアドレスから来たかどうかを検証することができます。",
        "Time Offset": "時間オフセット",
        "Timestamp": "タイムスタンプ",
        "Today": "今日",
        "Total Amount": "Komodo総量",
        "Total Received": "総入金額",
        "Total Sent": "総送金額",
    ...
    gettextCatalog.setStrings('ru', {
        "(Input unconfirmed)": "(неподтвержденный вход)",
        "404 Page not found :(": "404 Страница не найдена :(",
        "<a href=\"https://komodoplatform.com\" target=\"_blank\" title=\"Komodo Platform\">Komodo Platform</a> strives to accelerate the adoption of blockchain technologies around the globe and to lead the world in blockchain integration. All of the Komodo’s unique and cutting-edge technologies are open-source and available to everyone.": "<a href=\"https://komodoplatform.com\" target=\"_blank\" title=\"Komodo Platform\">Komodo Platform</a> strives to accelerate the adoption of blockchain technologies around the globe and to lead the world in blockchain integration. All of the Komodo’s unique and cutting-edge technologies are open-source and available to everyone.",
        "Address": "Адрес",
        "Age": "Время",
        "An error occured in the verification process.": "Произошла ошибка в процессе проверки.",
        "An error occured:<br>{{error}}": "Произошла ошибка:<br>{{error}}",
        "Application Status": "Статус приложения",
        "Block": "Блок",
        "Block Reward": "Награда за блок",
        "Blocks": "Блоки",
        "Broadcast Raw Transaction": "Отправить raw-транзакцию в сеть",
        "Can't connect to insight server. Attempting to reconnect...": "Ошибка подклоючения к серверу insight. Повторная попытка...",
        "Can't connect to internet. Please, check your connection.": "Ошибка подключения к интернет. Пожалуйста, проверьте соединение.",
        "Can't connect to komodod to get live updates from the p2p network. (Tried connecting to komodod at {{host}}:{{port}} and failed.)": "Ошибка подключения к komodod для получения обновлений из сети. (Попытка подключения к {{host}}:{{port}} не удалась.)",
        "Charts": "Графики",
        "Complete": "Завершено",
        "Confirmations": "Подтверждений",
        "Conn": "Узлы",
        "Connections to other nodes": "Соединений с другими узлами",
        "Current Blockchain Tip (insight)": "Текущая вершина блокчейна (insight)",
        "Current Sync Status": "Текущий статус синхронизации",
        "Details": "Подробная информация",
        "Difficulty": "Сложность",
        "Double spent attempt detected. From tx:": "Попытка двойной траты. Транзакция:",
        "End-to-end Blockchain Solutions Provider empowering developers to build freely\nand participate in creating the largest open blockchain network.": "End-to-end Blockchain Solutions Provider empowering developers to build freely\nand participate in creating the largest open blockchain network.",
        "Error message:": "Описание ошибки:",
        "Error!": "Ошибка!",
        "Fee": "Комиссия",
        "Fee Rate": "Размер комисии",
        "Final Balance": "Итоговый баланс",
        "Finish Date": "Время завершения",
        "Go to home": "Домой",
        "Height": "Высота",
        "Included in Block": "Входит в блок",
        "Incoherence in levelDB detected:": "Нарушение связности в LevelDB:",
        "Info Errors": "Информация об ошибках",
        "Initial Block Chain Height": "Начальная высота блокчейна",
        "Input": "Вход",
        "Komodo comes with a way of signing arbitrary messages.": "Komodo comes with a way of signing arbitrary messages.",
        "Komodo node information": "Информация об узле",
        "Last Block": "Последний блок",
        "Last Block Hash (Komodod)": "Хеш последнего блока (komodod)",
        "Latest Blocks": "Последние блоки",
        "Latest Transactions": "Последние транзакции",
        "Loading Address Information": "Загрузка информации\n об адресе",
        "Loading Block Information": "Загрузка информации о блоке",
        "Loading Selected Date...": "Загрузка выбранной даты...",
        "Loading Transaction Details": "Загрузка деталей транзакции",
        "Loading Transactions...": "Загрузка транзакций...",
        "Loading chart...": "Загрузка графиков...",
        "Loading...": "Загрузка...",
        "Message": "Сообщение",
        "Mined Time": "Время получения",
        "Mined by": "Майнер",
        "Mining Difficulty": "Сложность майнинга",
        "Network": "Сеть",
        "Next Block": "Следующий блок",
        "No Inputs": "Нет входов",
        "No Inputs (Newly Generated Coins)": "Нет входов (coinbase транзакция)",
        "No JoinSplits": "Нет операций (sprout)",
        "No Outputs": "Нет выходов",
        "No Shielded Spends and Outputs": "Нет операций (sapling)",
        "No blocks yet.": "Пока нет блоков.",
        "No matching records found!": "Не найдено записей!",
        "No. Transactions": "Всего транзакций",
        ...
        "Public input": "Публичный вход",
        "Public output": "Публичный выход",
        "Raw transaction data": "Raw данные транзакции",
        "Raw transaction data must be a valid hexadecimal string.": "Raw данные транзакции должны быть правильной hex строкой.",
        "Received Time": "Время получения",
        "Redirecting...": "Перенаправление ...",
        "Search for block, transaction or address": "Поиск блока, транзакции или адреса",
        "See all blocks": "Просмотр всех блоков",
        ...
        "Status": "Статус",
        "Summary": "Итог",
        "Summary <small>confirmed</small>": "Итог <small>подтвержденный</small>",
        "Sync Progress": "Синхронизация",
        "Sync Status": "Статус синхронизации",
        "Sync Type": "Тип синхронизации",
        "Synced Blocks": "Синхронизировано блоков",
        "The message failed to verify.": "Проверка подписи сообщения не пройдена.",
        "The message is verifiably from {{verification.address}}.": "Сообщение подписано отправителем {{verification.address}}.",
        "There are no transactions involving this address.": "Для этого адреса нет транзакций.",
        "This form can be used to broadcast a raw transaction in hex format over\n        the Komodo network.": "Эта форма может быть использована для отправки raw транзакции в hex\n        формате через сеть.",
        "This form can be used to verify that a message comes from\n        a specific Komodo address.": "Эта форма может быть использована для проверки\n        отправителя (адреса) сообщения.",
        ...
        "Transaction succesfully broadcast.<br>Transaction id: {{txid}}": "Транзакция успешно отправлена.<br>TXID: {{txid}}",
        "Transactions": "Транзакции",
        "Type": "Тип",
        "Unconfirmed": "Нет подтверждений",
        "Unconfirmed Transaction!": "Неподтвержденная транзакция!",
        "Unconfirmed Txs Balance": "Баланс неподтвержденных транзакций",
        "Value Out": "Сумма",
        "Verify": "Проверить",
        "Verify signed message": "Проверить подпись сообщения",
        "Version": "Версия",
        "Waiting for blocks...": "Ожидание блоков...",
        "Waiting for transactions...": "Ожидание транзакций...",
        "What is Komodo?": "What is Komodo?",
        "by date.": "по дате.",
        "first seen at": "первое появление",
        "mined": "дата",
        "mined on:": "дата:"
    });
    /* jshint +W100 */
